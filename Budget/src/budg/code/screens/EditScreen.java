...
public class EditScreen extends ScreenMaster implements ActionListener {

	private static JPanel buttonHolder;
	private static Bill selectedBill = null;

	public EditScreen(int width, int height) {
		super(width, height);
	}
	...
	private void addButtons() {
		...
		select.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// change bill creator screen's mode to edit
				CreateScreen.setInEditMode(true);
				// allow bill creator screen to have current bill's data
				CreateScreen.editBill(selectedBill);
				// switch to CreateScreen
